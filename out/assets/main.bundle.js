...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_scss__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(26);
...
socket.on('cast feeling', data => {
  ...
  if (initialLocation) {
    ...
    marker.addListener('click', (e) => {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#cast-output-p').html(feelingString);
    });
  } else if (infowindow == nearestMarker.infowindow && __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#cast-output-p').length > 0) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.feeling').get(0)).before(createFeeling(data));
